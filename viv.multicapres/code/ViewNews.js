...
module.exports.function = function ViewNews(newsCategory, dateTime, person,srcfrom,location,keywords,searchOption,currentL,newsDateTimeInterval,$vivContext) {
  var categoryLength;
  var index1,index2;
  var category;
  ...
  var newsInfo = newsApiLib.getViewNewsData(category, dateTime, person,srcfrom,location,keywords,searchOption,currentL,$vivContext);
  return  newsInfo;
}
